...
@ curl -u %uname%:%passwd% -H "Content-Type: application/json" -H "X-Requested-With: XMLHttpRequest" -k -d "{\"key\": \"urn:curriculum:config:1\", \"value\": \"urn:thingworx:template:curriculum\"}" %server%/ExperienceService/id-resolution/mappings
...
@ curl -u %uname%:%passwd% -H "Content-Type: application/json" -H "X-Requested-With: XMLHttpRequest" -k -d "{\"key\": \"urn:curriculum:config:2\", \"value\": \"urn:thingworx:template:curriculum\"}" %server%/ExperienceService/id-resolution/mappings

@rem map ThingMark to configuration 2. You will need to change the name of the ThingMark to your own
@ curl -u %uname%:%passwd% -H "Content-Type: application/json" -H "X-Requested-With: XMLHttpRequest" -k -d "{\"key\": \"urn:vuforia:vumark:%vumark1%\", \"value\": \"urn:curriculum:config:2\"}" %server%/ExperienceService/id-resolution/mappings
...
@ curl -u %uname%:%passwd% -H "Content-Type: application/json" -H "X-Requested-With: XMLHttpRequest" -k -d "{\"key\": \"urn:curriculum:config:3\", \"value\": \"urn:thingworx:template:curriculum\"}" %server%/ExperienceService/id-resolution/mappings

@rem map ThingMark to configuration 3. You will need to change the name of the ThingMark to your own
@ curl -u %uname%:%passwd% -H "Content-Type: application/json" -H "X-Requested-With: XMLHttpRequest" -k -d "{\"key\": \"urn:vuforia:vumark:%vumark1%\", \"value\": \"urn:curriculum:config:3\"}" %server%/ExperienceService/id-resolution/mappings