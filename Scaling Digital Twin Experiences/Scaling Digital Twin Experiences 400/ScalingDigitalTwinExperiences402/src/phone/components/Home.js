...
$scope.app.params.guidesrc = '/ExperienceService/content/reps/sdte400/targets/' + $scope.app.params.guide; 
$scope.app.params.imagesrc = 'vuforia-image:////ExperienceService/content/reps/sdte400/targets/' + $scope.app.params.target;
