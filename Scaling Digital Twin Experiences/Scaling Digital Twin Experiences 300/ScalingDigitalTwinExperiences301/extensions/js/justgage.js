...
JustGage.prototype.generateShadow = function(svg, defs) {
  ...
  //=============================  Modification of the JustGage library to use the session ID instead of the window.location because of our different index files in preview and in the built experience ===========
  // set shadow
