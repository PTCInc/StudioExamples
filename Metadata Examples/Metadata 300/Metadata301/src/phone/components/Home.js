...
if (instructionName.length ==0) {
      ...
      $scope.popup = $ionicPopup.show({
        ...
        '&nbsp;</div><div class="btnadd" ng-click="hiliteOff();popup.close();addToCart();">Add to Cart</div>' + '<div class="btncontinue" ng-click="hiliteOff();popup.close();">Continue</div>',        
        //
      ...
      $scope.popup = $ionicPopup.show({
        ...
        //template for the popup with added buttons
        template: '<div>' + $scope.app.params.itemCount + 'x &nbsp;' + partNumber + '&nbsp;</br>' + partName + '&nbsp;</br> ' + price +
        '&nbsp;</div><div class= "btnadd" ng-click="hiliteOff();popup.close();addToCart();">Add to Cart</div>' + '<div class="btndisassemble" ng-click="hiliteOff();popup.close();disassemble();">Disassemble</div>' + '<div class="btncontinue" ng-click="hiliteOff();popup.close();">Continue</div>',      
        //
        // set the scope for the popup
        scope: $scope
    ...
    $scope.disassemble = function () {
      ...
      var modelObject = { model: targetName, instruction: 'l-Creo 3D - ' + instructionName + '.pvi' };
      //
